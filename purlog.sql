...
insert  into `tr_do`(`id_do`,`id_courir`,`date_create`,`id_user`,`status`) values (1,1,'2015-01-20 11:08:30','1',2),(2,2,'2015-01-20 11:08:53','1',2);
...
insert  into `tr_qr`(`id_qr`,`id_qrs`,`id_pr`,`id_vendor`,`id_po`,`top`,`ETD`,`status`) values (43,13,1,'V001',17,2,'2015-02-06',2),(44,13,1,'V002',0,4,'2015-02-06',1),(45,13,1,'V003',0,5,'2015-02-06',1),(46,14,1,'V001',0,13,'2015-02-06',1),(47,14,1,'V002',18,4,'2015-02-06',2),(48,14,1,'V003',0,5,'2015-02-06',1),(49,16,6,'V001',0,12,'2015-02-07',1),(50,16,6,'V002',19,2,'2015-02-07',2),(51,16,6,'V003',0,3,'2015-02-07',1),(52,17,6,'V001',0,11,'2015-02-07',1),(53,17,6,'V002',0,12,'2015-02-07',1),(54,17,6,'V003',0,34,'2015-02-07',1);
...
insert  into `tr_qrs_detail`(`id_detail_qrs`,`id_qrs`,`id_pr`,`id_detail_pr`,`kode_barang`,`qty`,`status`) values (26,13,1,1,'100',4,1),(27,13,1,2,'201',3,1),(28,13,1,3,'203',3,1),(29,14,1,1,'100',4,1),(30,14,1,2,'201',4,1),(31,14,1,3,'203',1,1),(32,16,6,9,'201',100,1),(33,17,6,9,'201',23,1);
...
insert  into `tr_receive`(`id_receive`,`id_courir`,`id_sro`,`date_create`,`id_user`,`status`) values (1,1,1,'2015-01-19 00:00:00',1,1),(2,2,2,'2015-01-19 00:00:00',1,2);
...
insert  into `tr_ro`(`id_ro`,`user_id`,`purpose`,`cat_req`,`ext_doc_no`,`ETD`,`date_create`,`date_approve`,`date_reject`,`status`,`status_order`) values (19,1,'REQUEST','ASSET','1','2015-02-03','2015-02-03 12:48:48','2015-02-03 13:46:42','0000-00-00 00:00:00',6,1),(20,1,'REQUEST','ATK','1234','2015-02-04','2015-02-04 16:27:03','2015-02-04 16:28:30','0000-00-00 00:00:00',6,1),(21,16,'REQUEST','ASSET','12354','2015-02-06','2015-02-06 17:28:29','2015-02-06 17:29:24','0000-00-00 00:00:00',6,1),(22,16,'REQUEST','ASSET','89898','2015-02-07','2015-02-07 14:15:47','0000-00-00 00:00:00','0000-00-00 00:00:00',1,1);
...
insert  into `tr_sro`(`id_sro`,`id_do`,`id_ro`,`date_create`,`id_user`,`status`) values (1,1,2,'2015-01-19 00:00:00','1',2),(2,2,3,'2015-01-19 00:00:00','1',2),(3,NULL,19,'2015-02-06 00:00:00','1',1);
...
insert  into `tr_stock`(`id_stock`,`id_in`,`id_detail_in`,`kode_barang`,`qty`,`price`,`id_lokasi`,`date_create`,`status`,`type_in`) values (1,NULL,NULL,'301',2,1000,'Workshop','2015-01-20 10:54:09',1,NULL),(2,NULL,NULL,'302',0,500,'Heavy Equipment','2015-01-20 10:54:09',1,NULL),(3,NULL,NULL,'201',0,250,'Pusat','2015-01-20 10:54:09',1,0),(4,NULL,NULL,'100',2,210,'IT','2015-02-07 01:33:33',1,NULL),(5,2,6,'201',23,NULL,'Pusat','2015-02-07 02:02:53',1,1),(6,2,7,'201',54,NULL,'Pusat','2015-02-07 02:02:53',1,1);
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_po_inbound_2` AS select `x`.`id_detail_pr` AS `id_detail_pr`,`x`.`id_pr` AS `id_pr`,`z`.`id_po` AS `id_po`,`x`.`kode_barang` AS `kode_barang`,`x`.`qty` AS `asal`,coalesce(sum(`y`.`qty`),0) AS `receive`,(`x`.`qty` - coalesce(sum(`y`.`qty`),0)) AS `sisa`,`a`.`nama_barang` AS `nama_barang` from (((`tr_qrs_detail` `x` left join `tr_in_detail` `y` on((`x`.`id_detail_pr` = `y`.`ext_rec_no_detail`))) left join `tr_qrs` `z` on((`x`.`id_pr` = `z`.`id_pr`))) left join `ref_barang` `a` on((`x`.`kode_barang` = convert(`a`.`kode_barang` using utf8)))) where (`z`.`id_po` <> '') group by `x`.`id_detail_pr` */;
