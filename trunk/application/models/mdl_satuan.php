...
class mdl_satuan extends CI_Model {
  ...
  function getdata($plimit=true){
		...
		$sort = isset($_POST['sort']) ? strval($_POST['sort']) : 'a.nama_satuan';  
		...
		$this->db->flush_cache();
		$this->db->start_cache();
			$this->db->select('a.id_satuan, a.nama_satuan, b.status_satuan');
			$this->db->from('ref_satuan a');
			$this->db->join('v_status_satuan b', 'b.id_satuan = a.id_satuan');
