...
class mdl_report_outstanding extends CI_Model {
	...
	function report_delivery_pdf($date_1,$date_2)
	{
		$this->db->flush_cache();
		$this->db->start_cache();
			$this->db->select('a.id_po,a.purpose,a.cat_req,a.ext_doc_no,a.ETD,y.full_name,z.departement_name,g.name_vendor,f.kode_barang,h.nama_barang,d.qty diterima,f.qty dipesan,d.price,a.date_create,(f.qty*d.price) total,(d.qty-f.qty) outstanding');
			$this->db->from('tr_po a');
