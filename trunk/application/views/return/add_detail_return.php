<script>
  ...
  $(document).ready(function(){
    ...
    loaddata = function(){
      $.ajax({ 
        type: "POST",   
        url: base_url+'retur/getdata_add_detail_return',   
    ...
    saveData = function(){
      $('#form3').form('submit',{
        url: base_url+'retur/saveDetail/<?php echo $id_return;?>',
        onSubmit: function(){
      ...
      <div class="fsearch">
        <table border="0" cellpadding="1" cellspacing="1">
          <tr>
            <td>ID Receive</td>
            <td>: 
              <input name="id_receive" readonly="True" size="10" value="<?=$id_receive?>">
              <!-- <select id="id_receive" name="id_receive" style="width:80px;">
                <?=$this->mdl_prosedur->OptionReceive_DetailReturn(array('value'=>$id_receive));?>
              </select> -->
            </td>
            <td>&nbsp;&nbsp;&nbsp;</td>
  ...
  <table class="tbl">
    <thead>
      <tr>
        ...
        <th width="" bgcolor="#F4F4F4">ID Receive</th>
        <th width="" bgcolor="#F4F4F4">ID Detail Receive</th>
