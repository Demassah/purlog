...
<p></p>
	...
	<table width= "100%" border="0.5" bordercolor="#000000" class='tblbtl' cellspacing=0 cellpadding=0>
	  <tr>
		...
		<th width="120" align="center">ID PR</th>
		<th width="120" align="center">ID RO</th>
		<th width="120" align="center">ID Detail RO</th>
		<th width="125" align="center">Kode Barang</th>
		<th width="165" align="center">Nama Barang</th>
		<th width="50" align="center">Qty</th>
		<th width="180" align="center">Note</th>
	  ...
	  <tr>
		...
		<td align="center"><?php echo $data->id_pr;?></td>
		...
		<td align="center"><?php echo $data->note;?></td>
	  </tr>
	  <?php 
		$no++;
	//foreach
	...
	<div class="class="footer"">
		...
		<tr>
				...
				<td width="330" align="center"></td>
				<td width="330" align="center">Bandung,<?php echo tgl_indo(date('Y-m-d'))?></td>
			</tr>
			<tr>
				<td width="330" align="center">Mengajukan</td>
