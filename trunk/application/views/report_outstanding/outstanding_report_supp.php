...
<h4 align="center"><b>Laporan Outstanding</b></h4>
<p></p>
<p></p>
<p></p>
<p></p>
	...
	<br/>
<!-- <p align="center"><b>Laporan Pengiriman</b></p>
		<table >
		<tr>
			<td  align="left">Requestor</td>
			<td  align="left"> : <?php echo $data_pdf[0]->full_name;?></td>
	...
	<table width= "100%" border="0.5" bordercolor="#000000" class='' cellspacing=0 cellpadding=0>
		<tr>
			<td width="40" align="center" colspan="" rowspan="" headers=""><b>ID PO</b></td>
			<td width="120" align="center" colspan="" rowspan="" headers=""><b>Supplier</b></td>
			...
			<td width="60" align="center" colspan="" rowspan="" headers=""><b>Dipesan</b></td>
			<td width="60" align="center" colspan="" rowspan="" headers=""><b>Diterima</b></td>
			<td width="80" align="center" colspan="" rowspan="" headers=""><b>Outstanding</b></td>
			...
			<td width="120" align="center" colspan="" rowspan="" headers=""><b>Date Create</b></td>
		</tr>
		<?php 
			$no = 1;
			$total = 0;
		...
		<tr>
			...
			<td colspan="" rowspan=""  align="center" headers=""><? echo $data->dipesan; ?></td>
			<td colspan="" rowspan=""  align="center" headers=""><? echo $data->diterima; ?></td>
			<td colspan="" rowspan=""  align="center" headers=""><? echo $data->outstanding; ?></td>
		...
		<? 
	 	 ...
	 	 <tr>
	 	 		...
	 	 		<td colspan="4" rowspan=""  align="center" headers=""><strong><? echo "Rp." . number_format($total,2,',','.');?></strong></td>
	 	 </tr>
	</table>
		<br><br>
