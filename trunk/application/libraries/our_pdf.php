...
class our_pdf extends FPDF{
	...
	function Header(){
		//Logo
		$this->Image('asset/images/logo.png',10,3);
		//Arial bold 15
		$this->SetFont('Arial','B',20);
		//pindah ke posisi ke tengah untuk membuat judul
		$this->Cell(80);
		//judul
		$this->Cell(110,9,'UNIVERSITAS OTTOW GEISSLER PAPUA',0,0,'C');
		//pindah baris
		$this->Ln(20);
	...
	function CheckPageBreak($h)
	{
		...
		if($this->GetY()+$h>$this->PageBreakTrigger){
			...
			$this->setY(35);//tambahan dari chan agar di page setelah 1 posisi header kembali keatas
