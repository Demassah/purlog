...
INSERT INTO `tr_in` VALUES ('6', '17', '1', '2015-02-10 08:39:22', '16', '1');
...
-- ----------------------------
INSERT INTO `tr_in_detail` VALUES ('4', '5', '201', '66', '9', 'Pusat', '1');
INSERT INTO `tr_in_detail` VALUES ('5', '6', '100', '2', '1', 'IT', '1');
INSERT INTO `tr_in_detail` VALUES ('6', '6', '201', '2', '2', 'Pusat', '1');
INSERT INTO `tr_in_detail` VALUES ('7', '6', '203', '2', '3', '', '1');
...
INSERT INTO `tr_notifikasi` VALUES ('52', 'Request Order telah dikirim ke RO Approval', 'request_order_approval', '22', '0', '0000-00-00', '1', '1', '1', '2');
INSERT INTO `tr_notifikasi` VALUES ('53', 'RO Approval telah dikirim ke RO Logistic', 'request_order_logistic', '22', '0', '0000-00-00', '1', '1', '1', '2');
INSERT INTO `tr_notifikasi` VALUES ('54', 'RO Logistic telah dikirim ke RO Selected', 'request_order_selected', '22', '0', '0000-00-00', '1', '1', '1', '2');
...
INSERT INTO `tr_pros_detail` VALUES ('4', '13', '21', '4', '0', '201', '23', 'CROSSDOCK', '2015-02-07 02:02:53', '1', '0', '2');
INSERT INTO `tr_pros_detail` VALUES ('5', '13', '21', '4', '0', '201', '54', 'CROSSDOCK', '2015-02-07 02:02:53', '1', '0', '2');
INSERT INTO `tr_pros_detail` VALUES ('6', '14', '22', null, '4', '100', '2', 'IT', '2015-02-10 09:24:47', '1', '0', '1');
INSERT INTO `tr_pros_detail` VALUES ('7', '16', '22', null, '1', '301', '2', 'Workshop', '2015-02-10 09:24:47', '1', '0', '1');
...
INSERT INTO `tr_ro` VALUES ('22', '16', 'REQUEST', 'ASSET', '89898', '2015-02-07', '2015-02-07 14:15:47', '2015-02-10 09:24:25', '0000-00-00 00:00:00', '5', '1');
...
INSERT INTO `tr_ro_detail` VALUES ('15', '22', '89898', '100', '12', '1', '16', '2015-02-07 14:15:47', 'sadasda', '1', '0', '0');
INSERT INTO `tr_ro_detail` VALUES ('16', '22', '89898', '301', '12', '1', '16', '2015-02-07 14:15:47', 'xzcxzc', '1', '0', '0');
...
INSERT INTO `tr_sro` VALUES ('4', null, '21', '2015-02-10 00:00:00', '16', '1');
...
INSERT INTO `tr_stock` VALUES ('4', null, null, '100', '0', '210', 'IT', '2015-02-07 01:33:33', '1', null);
...
x.qty AS asal,
COALESCE(y.qty,0) AS receive,
(`x`.`qty` - COALESCE(y.qty,0)) AS sisa,
a.nama_barang,
y.id_in,
tr_in.ext_rec_no,
tr_in.id_in AS id_in_asal,
tr_stock.id_lokasi
FROM
(((tr_qrs_detail AS x
LEFT JOIN tr_in_detail AS y ON ((x.id_detail_pr = y.ext_rec_no_detail)))
LEFT JOIN tr_qrs AS z ON ((x.id_pr = z.id_pr)))
LEFT JOIN ref_barang AS a ON ((x.kode_barang = convert(`a`.`kode_barang` using utf8))) AND x.kode_barang = a.kode_barang)
LEFT JOIN tr_in ON z.id_po = tr_in.ext_rec_no
LEFT JOIN tr_stock ON x.kode_barang = tr_stock.kode_barang
GROUP BY
x.id_detail_pr ;
