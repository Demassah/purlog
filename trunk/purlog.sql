...
-- ----------------------------
INSERT INTO `ref_courir` VALUES ('1', 'Asep Zaelani', '0811115214', '1');
INSERT INTO `ref_courir` VALUES ('2', 'Jajang Nurjaman', '0857456895', '1');
INSERT INTO `ref_courir` VALUES ('3', 'Dea fajarrr', '000000', '0');
...
-- ----------------------------
INSERT INTO `ref_lokasi` VALUES ('1', 'A100', '1', '1', '1');
INSERT INTO `ref_lokasi` VALUES ('2', 'B100', '2', '2', '1');
INSERT INTO `ref_lokasi` VALUES ('3', 'C100', '2', '3', '1');
...
INSERT INTO `sys_menu` VALUES ('10', 'Logistic', 'Request Order', '34', 'request_order', '2', '0', 'icon-ro', 'ACCESS;ADD;EDIT;DELETE;DETAIL;APPROVE;PDF;');
INSERT INTO `sys_menu` VALUES ('11', 'Logistic', 'Request Order Selected', '34', 'request_order_selected', '5', '0', 'icon-ros', 'ACCESS;EDIT;DELETE;DETAIL;APPROVE;PDF;');
...
INSERT INTO `sys_menu` VALUES ('43', 'Logistic', 'Transfer', '34', 'transfer', '26', '0', 'icon-transfer', 'ACCESS;ADD;EDIT;DELETE;DETAIL;APPROVE;');
INSERT INTO `sys_menu` VALUES ('44', 'Setup', 'Satuan', '36', 'satuan', '3', '0', 'icon-satuan', 'ACCESS;ADD;EDIT;DELETE;');
INSERT INTO `sys_menu` VALUES ('45', 'Master Data', 'Kurir', '5', 'courir', '5', '0', 'icon-po', 'ACCESS;ADD;EDIT;DELETE;');
INSERT INTO `sys_menu` VALUES ('46', 'Master Data', 'Lokasi', '5', 'lokasi', '6', '0', 'icon-otoritas', 'ACCESS;ADD;EDIT;DELETE;');
INSERT INTO `sys_menu` VALUES ('47', 'Laporan', 'Laporan', '0', '#', '5', '0', 'icon-ordered', 'ACCESS;');
INSERT INTO `sys_menu` VALUES ('48', 'Laporan', 'Laporan Picking', '47', 'laporan_picking', '1', '0', 'icon-po', 'ACCESS;PDF;EXCEL;');
INSERT INTO `sys_menu` VALUES ('49', 'Laporan', 'Laporan Delivery Order', '47', 'laporan_delivery', '2', '0', 'icon-po', 'ACCESS;PDF;EXCEL;');
INSERT INTO `sys_menu` VALUES ('50', 'Laporan', 'Laporan Document Receive', '47', 'laporan_document', '4', '0', 'icon-po', 'ACCESS;PDF;EXCEL;');
INSERT INTO `sys_menu` VALUES ('51', 'Laporan', 'Laporan Shipment', '47', 'laporan_shipment', '3', '0', 'icon-po', 'ACCESS;PDF;EXCEL;');
INSERT INTO `sys_menu` VALUES ('52', 'Laporan', 'Laporan Inbound', '47', 'laporan_inbound', '5', '0', 'icon-po', 'ACCESS;PDF;EXCEL;');
INSERT INTO `sys_menu` VALUES ('53', 'Laporan', 'Laporan Purchase', '47', 'laporan_purchase', '6', '0', 'icon-po', 'ACCESS;PDF;EXCEL;');
INSERT INTO `sys_menu` VALUES ('54', 'Laporan', 'Laporan Pembelian', '47', 'laporan_pembelian', '7', '0', 'icon-po', 'ACCESS;PDF;EXCEL;');
INSERT INTO `sys_menu` VALUES ('55', 'Laporan', 'Laporan Outstanding Supply', '47', 'laporan_outstanding', '8', '0', 'icon-po', 'ACCESS;PDF;EXCEL;');
INSERT INTO `sys_menu` VALUES ('56', 'Laporan', 'Laporan Penerimaan ', '47', 'laporan_penerimaan', '9', '0', 'icon-po', 'ACCESS;PDF;EXCEL;');
INSERT INTO `sys_menu` VALUES ('57', 'Laporan', 'Laporan Pemakaian', '47', 'laporan_usage', '10', '0', 'icon-po', 'ACCESS;PDF;EXCEL;');
INSERT INTO `sys_menu` VALUES ('58', 'Laporan', 'Laporan Persediaan', '47', 'laporan_persediaan', '11', '0', 'icon-po', 'ACCESS;PDF;EXCEL;');
...
INSERT INTO `sys_user_access` VALUES ('730', '8', '1', 'ACCESS;ADD;EDIT;DELETE;PDF;');
INSERT INTO `sys_user_access` VALUES ('731', '9', '1', 'ACCESS;ADD;DETAIL;EDIT;DELETE;');
INSERT INTO `sys_user_access` VALUES ('732', '10', '1', 'ACCESS;ADD;DETAIL;EDIT;DELETE;PDF;APPROVE;');
INSERT INTO `sys_user_access` VALUES ('733', '11', '1', 'ACCESS;DETAIL;EDIT;DELETE;PDF;APPROVE;');
...
INSERT INTO `sys_user_access` VALUES ('739', '17', '1', 'ACCESS;ADD;EDIT;DELETE;SELECT;PRINT;PDF;EXCEL;IMPORT;APPROVE;');
...
INSERT INTO `sys_user_access` VALUES ('742', '20', '1', 'ACCESS;ADD;DETAIL;EDIT;DELETE;');
...
INSERT INTO `sys_user_access` VALUES ('755', '43', '1', 'ACCESS;ADD;DETAIL;EDIT;DELETE;APPROVE;');
...
INSERT INTO `sys_user_access` VALUES ('821', '45', '1', 'ACCESS;ADD;EDIT;DELETE;');
INSERT INTO `sys_user_access` VALUES ('822', '46', '1', 'ACCESS;ADD;EDIT;DELETE;');
INSERT INTO `sys_user_access` VALUES ('823', '47', '1', 'ACCESS;');
INSERT INTO `sys_user_access` VALUES ('824', '48', '1', 'ACCESS;PDF;EXCEL;');
INSERT INTO `sys_user_access` VALUES ('825', '49', '1', 'ACCESS;PDF;EXCEL;');
INSERT INTO `sys_user_access` VALUES ('826', '51', '1', 'ACCESS;PDF;EXCEL;');
INSERT INTO `sys_user_access` VALUES ('827', '50', '1', 'ACCESS;PDF;EXCEL;');
INSERT INTO `sys_user_access` VALUES ('828', '52', '1', 'ACCESS;PDF;EXCEL;');
INSERT INTO `sys_user_access` VALUES ('829', '53', '1', 'ACCESS;PDF;EXCEL;');
INSERT INTO `sys_user_access` VALUES ('830', '54', '1', 'ACCESS;PDF;EXCEL;');
INSERT INTO `sys_user_access` VALUES ('831', '55', '1', 'ACCESS;PDF;EXCEL;');
INSERT INTO `sys_user_access` VALUES ('832', '56', '1', 'ACCESS;PDF;EXCEL;');
INSERT INTO `sys_user_access` VALUES ('833', '57', '1', 'ACCESS;PDF;EXCEL;');
INSERT INTO `sys_user_access` VALUES ('834', '58', '1', 'ACCESS;PDF;EXCEL;');
INSERT INTO `sys_user_access` VALUES ('835', '45', '14', 'ACCESS;ADD;EDIT;DELETE;');
INSERT INTO `sys_user_access` VALUES ('836', '46', '14', 'ACCESS;ADD;EDIT;DELETE;');
INSERT INTO `sys_user_access` VALUES ('837', '47', '14', 'ACCESS;');
INSERT INTO `sys_user_access` VALUES ('838', '48', '14', '');
INSERT INTO `sys_user_access` VALUES ('839', '49', '14', '');
INSERT INTO `sys_user_access` VALUES ('840', '51', '14', '');
INSERT INTO `sys_user_access` VALUES ('841', '50', '14', '');
INSERT INTO `sys_user_access` VALUES ('842', '52', '14', '');
INSERT INTO `sys_user_access` VALUES ('843', '53', '14', '');
INSERT INTO `sys_user_access` VALUES ('844', '54', '14', 'ACCESS;PDF;EXCEL;');
INSERT INTO `sys_user_access` VALUES ('845', '55', '14', 'ACCESS;PDF;EXCEL;');
INSERT INTO `sys_user_access` VALUES ('846', '56', '14', 'ACCESS;PDF;EXCEL;');
INSERT INTO `sys_user_access` VALUES ('847', '57', '14', 'ACCESS;PDF;EXCEL;');
INSERT INTO `sys_user_access` VALUES ('848', '58', '14', 'ACCESS;PDF;');
...
-- Records of tr_do
-- ----------------------------
INSERT INTO `tr_do` VALUES ('1', '1', '2015-01-20 11:08:30', '1', '2');
INSERT INTO `tr_do` VALUES ('2', '2', '2015-01-20 11:08:53', '1', '2');
INSERT INTO `tr_do` VALUES ('4', '1', '2015-02-10 14:32:43', '16', '2');
INSERT INTO `tr_do` VALUES ('5', '1', '2015-03-20 13:43:30', '1', '2');
...
-- Records of tr_in
-- ----------------------------
INSERT INTO `tr_in` VALUES ('1', '17', '1', '2015-02-01 10:24:42', '16', '2');
INSERT INTO `tr_in` VALUES ('2', '19', '1', '2015-02-02 13:44:44', '1', '2');
INSERT INTO `tr_in` VALUES ('3', '20', '1', '2015-02-03 15:42:57', null, null);
INSERT INTO `tr_in` VALUES ('4', '21', '1', '2015-02-04 15:43:03', null, null);
INSERT INTO `tr_in` VALUES ('5', '22', '1', '2015-02-05 15:43:09', null, null);
...
-- ----------------------------
INSERT INTO `tr_in_detail` VALUES ('1', '1', '201', '25', '9', 'Pusat', '2015-02-01 00:00:00', '1');
INSERT INTO `tr_in_detail` VALUES ('2', '2', '201', '10', '8', 'Pusat', '2015-02-02 00:00:00', '1');
INSERT INTO `tr_in_detail` VALUES ('3', '3', '202', '5', '7', null, '2015-02-03 00:00:00', '1');
INSERT INTO `tr_in_detail` VALUES ('4', '4', '202', '5', '77', null, '2015-02-04 00:00:00', '1');
INSERT INTO `tr_in_detail` VALUES ('5', '5', '203', '10', '7', null, '2015-02-05 00:00:00', '1');
...
INSERT INTO `tr_notifikasi` VALUES ('51', 'Request Order Baru telah dibuat', 'request_order', '22', '0', '0000-00-00', '1', '1', '1', '2');
INSERT INTO `tr_notifikasi` VALUES ('52', 'Request Order Baru telah dibuat', 'request_order', '23', '0', '0000-00-00', '1', '1', '1', '2');
INSERT INTO `tr_notifikasi` VALUES ('53', 'Request Order telah dikirim ke RO Approval', 'request_order_approval', '23', '0', '0000-00-00', '1', '1', '1', '2');
INSERT INTO `tr_notifikasi` VALUES ('54', 'RO Approval telah dikirim ke RO Logistic', 'request_order_logistic', '23', '0', '0000-00-00', '1', '1', '1', '2');
INSERT INTO `tr_notifikasi` VALUES ('55', 'RO Logistic telah dikirim ke RO Selected', 'request_order_selected', '23', '1', '0000-00-00', '1', '1', '1', '2');
INSERT INTO `tr_notifikasi` VALUES ('56', 'Request Order Baru telah dibuat', 'request_order', '24', '0', '0000-00-00', '1', '1', '1', '2');
INSERT INTO `tr_notifikasi` VALUES ('57', 'Request Order telah dikirim ke RO Approval', 'request_order_approval', '24', '0', '0000-00-00', '1', '1', '1', '2');
INSERT INTO `tr_notifikasi` VALUES ('58', 'RO Approval telah dikirim ke RO Logistic', 'request_order_logistic', '24', '0', '0000-00-00', '1', '1', '1', '2');
INSERT INTO `tr_notifikasi` VALUES ('59', 'RO Logistic telah dikirim ke RO Selected', 'request_order_selected', '24', '0', '0000-00-00', '1', '1', '1', '2');
INSERT INTO `tr_notifikasi` VALUES ('60', 'Request Order Baru telah dibuat', 'request_order', '25', '0', '0000-00-00', '1', '1', '1', '2');
INSERT INTO `tr_notifikasi` VALUES ('61', 'Request Order telah dikirim ke RO Approval', 'request_order_approval', '25', '0', '0000-00-00', '1', '1', '1', '2');
INSERT INTO `tr_notifikasi` VALUES ('62', 'RO Approval telah dikirim ke RO Logistic', 'request_order_logistic', '25', '0', '0000-00-00', '1', '1', '1', '2');
INSERT INTO `tr_notifikasi` VALUES ('63', 'RO Logistic telah dikirim ke RO Selected', 'request_order_selected', '25', '0', '0000-00-00', '1', '1', '1', '2');
INSERT INTO `tr_notifikasi` VALUES ('64', 'Purchase Request Baru telah dibuat', 'purchase_request', '7', '0', '0000-00-00', '3', '1', '1', '3');
INSERT INTO `tr_notifikasi` VALUES ('65', 'Request Order telah dikirim ke RO Approval', 'request_order_approval', '22', '0', '0000-00-00', '1', '1', '1', '2');
INSERT INTO `tr_notifikasi` VALUES ('66', 'RO Approval telah dikirim ke RO Logistic', 'request_order_logistic', '22', '0', '0000-00-00', '1', '1', '1', '2');
INSERT INTO `tr_notifikasi` VALUES ('67', 'RO Logistic telah dikirim ke RO Selected', 'request_order_selected', '22', '0', '0000-00-00', '1', '1', '1', '2');
...
INSERT INTO `tr_po` VALUES ('20', '17', '6', '21', '16', '19', 'REQUEST', 'ASSET', '12354', '2015-02-06', '2015-02-12 09:46:36', '2');
...
INSERT INTO `tr_pr` VALUES ('7', '25', null, '16', 'STOCK', 'ASSET', '123', '2015-03-21', '2015-03-21 15:29:53', '2');
...
-- ----------------------------
INSERT INTO `tr_pros_detail` VALUES ('1', '4', '2', '1', '11', '201', '4', 'Workshop', '2015-02-01 20:06:59', '1', '1', '1');
INSERT INTO `tr_pros_detail` VALUES ('2', '5', '3', '2', '11', '201', '3', 'Workshop', '2015-02-02 20:07:24', '1', '1', '1');
INSERT INTO `tr_pros_detail` VALUES ('3', '9', '19', '3', '11', '201', '3', 'Pusat', '2015-02-03 13:51:25', '1', '1', '1');
...
INSERT INTO `tr_pr_detail` VALUES ('10', '0', '9', '19', '201', '2', '1', '2015-03-20 10:45:37', null, '1', '0');
INSERT INTO `tr_pr_detail` VALUES ('11', '0', '10', '20', '100', '34', '1', '2015-03-20 10:45:48', null, '1', '0');
INSERT INTO `tr_pr_detail` VALUES ('12', '0', '11', '20', '302', '12', '1', '2015-03-20 10:45:48', null, '1', '0');
INSERT INTO `tr_pr_detail` VALUES ('13', '0', '12', '20', '100', '12', '1', '2015-03-20 10:45:48', null, '1', '0');
INSERT INTO `tr_pr_detail` VALUES ('14', '0', '13', '21', '201', '46', '16', '2015-03-20 10:46:00', null, '1', '0');
INSERT INTO `tr_pr_detail` VALUES ('15', '0', '17', '24', '203', '20', '1', '2015-03-20 13:42:50', null, '1', '0');
INSERT INTO `tr_pr_detail` VALUES ('16', '7', '18', '25', '100', '12', '16', '2015-03-21 15:32:09', null, '2', '0');
...
INSERT INTO `tr_qr` VALUES ('52', '17', '6', 'V001', '0', '12', '2015-02-12', '1');
INSERT INTO `tr_qr` VALUES ('53', '17', '6', 'V002', '20', '2', '2015-02-12', '2');
INSERT INTO `tr_qr` VALUES ('54', '17', '6', 'V003', '0', '4', '2015-02-12', '1');
...
INSERT INTO `tr_qrs` VALUES ('17', '20', '6', '21', '2015-02-07 01:00:11', '16', '2');
INSERT INTO `tr_qrs` VALUES ('18', null, '5', '20', '2015-02-12 10:18:21', '16', '1');
...
INSERT INTO `tr_qrs_detail` VALUES ('36', '17', '6', '9', '201', '23', '1');
...
INSERT INTO `tr_qr_detail` VALUES ('158', '52', '17', '9', '6', '201', '23', '34', '2015-02-12 09:45:09', '1');
INSERT INTO `tr_qr_detail` VALUES ('159', '53', '17', '9', '6', '201', '23', '12', '2015-02-12 09:45:13', '1');
INSERT INTO `tr_qr_detail` VALUES ('160', '54', '17', '9', '6', '201', '23', '4', '2015-02-12 09:45:17', '1');
...
-- ----------------------------
INSERT INTO `tr_receive` VALUES ('1', '1', '1', '2015-01-19 00:00:00', '1', '2');
INSERT INTO `tr_receive` VALUES ('2', '2', '2', '2015-01-19 00:00:00', '1', '2');
INSERT INTO `tr_receive` VALUES ('3', '1', '3', '2015-02-06 00:00:00', '1', '2');
...
INSERT INTO `tr_receive_detail` VALUES ('3', '3', '3', '9', '19', '3', '201', '3', '2015-02-10 01:43:15', '1');
...
-- Records of tr_ro
-- ----------------------------
INSERT INTO `tr_ro` VALUES ('19', '1', 'REQUEST', 'ASSET', '1', '2015-02-03', '2015-02-03 12:48:48', '2015-02-03 13:46:42', '0000-00-00 00:00:00', 'aaaaabbbb12', 'D12DD', '6', '1');
INSERT INTO `tr_ro` VALUES ('20', '1', 'REQUEST', 'ATK', '1234', '2015-02-04', '2015-02-04 16:27:03', '2015-02-04 16:28:30', '0000-00-00 00:00:00', 'bbbbbcccc12', 'D13DE', '6', '1');
INSERT INTO `tr_ro` VALUES ('21', '16', 'REQUEST', 'ASSET', '12354', '2015-02-06', '2015-02-06 17:28:29', '2015-02-06 17:29:24', '0000-00-00 00:00:00', 'ccccccddddd12', 'D14DF', '6', '1');
INSERT INTO `tr_ro` VALUES ('22', '16', 'STOCK', 'ASSET', '89898', '2015-02-07', '2015-02-07 14:15:47', '2015-03-21 15:34:15', '0000-00-00 00:00:00', 'ddddeeee12', 'D15DG', '5', '1');
INSERT INTO `tr_ro` VALUES ('23', '1', 'REQUEST', 'ATK', '123', '2015-02-10', '2015-02-10 14:25:17', '2015-02-10 14:25:57', '0000-00-00 00:00:00', 'ffgggg12', 'D16DH', '4', '1');
INSERT INTO `tr_ro` VALUES ('24', '1', 'STOCK', 'ASSET', '11111', '2015-03-20', '2015-03-20 13:40:39', '2015-03-20 13:41:54', '0000-00-00 00:00:00', 'qw11111', 'D2345FG', '6', '1');
INSERT INTO `tr_ro` VALUES ('25', '16', 'STOCK', 'ASSET', '123', '2015-03-21', '2015-03-21 15:29:53', '2015-03-21 15:31:29', '0000-00-00 00:00:00', 'asd3432', 'dff45345', '6', '1');
...
INSERT INTO `tr_ro_detail` VALUES ('15', '23', '123', '302', '5', '2', '1', '2015-02-10 14:25:17', '-', '1', '0', '0');
INSERT INTO `tr_ro_detail` VALUES ('16', '24', '11111', '100', '12', '1', '1', '2015-03-20 13:40:39', 'PC unit', '1', '0', '0');
INSERT INTO `tr_ro_detail` VALUES ('17', '24', '11111', '203', '23', '2', '1', '2015-03-20 13:40:39', 'Mouse', '1', '0', '0');
INSERT INTO `tr_ro_detail` VALUES ('18', '25', '123', '100', '12', '1', '16', '2015-03-21 15:29:53', 'asdsad', '1', '0', '0');
...
INSERT INTO `tr_sro` VALUES ('3', '4', '19', '2015-02-06 00:00:00', '1', '2');
INSERT INTO `tr_sro` VALUES ('5', '5', '24', '2015-03-20 00:00:00', '1', '2');
...
-- Records of tr_stock
-- ----------------------------
INSERT INTO `tr_stock` VALUES ('11', '1', '1', '201', '15', '250', 'Pusat', '2015-02-01 10:54:09', '1', '0');
INSERT INTO `tr_stock` VALUES ('12', '2', '2', '201', '10', '450', 'Pusat', '2015-02-02 15:16:55', '1', '1');
INSERT INTO `tr_stock` VALUES ('13', '3', '3', '202', '5', '100', null, '2015-02-03 15:41:25', null, null);
INSERT INTO `tr_stock` VALUES ('14', '4', '4', '202', '5', '200', null, '2015-02-04 15:41:29', null, null);
INSERT INTO `tr_stock` VALUES ('15', '5', '5', '203', '10', '200', null, '2015-03-05 15:41:46', null, null);
...
-- ----------------------------
INSERT INTO `tr_transfer` VALUES ('1', '1', 'tes', '2015-01-19 23:43:10', '1', '2');
INSERT INTO `tr_transfer` VALUES ('2', '1', 'tes 2', '2015-01-19 23:45:15', '1', '1');
INSERT INTO `tr_transfer` VALUES ('3', '1', '-', '2015-02-10 13:33:58', '1', '1');
...
-- ----------------------------
INSERT INTO `tr_transfer_detail` VALUES ('7', '1', '1', '301', '1', '1000', 'A100', '1');
INSERT INTO `tr_transfer_detail` VALUES ('10', '2', '1', '301', '2', '1000', 'Workshop', '1');
INSERT INTO `tr_transfer_detail` VALUES ('15', '3', '2', '302', '7', '500', 'Pusat', '1');
INSERT INTO `tr_transfer_detail` VALUES ('16', '2', '3', '201', null, '250', null, '1');
INSERT INTO `tr_transfer_detail` VALUES ('17', '2', '5', '201', null, '100', null, '1');
INSERT INTO `tr_transfer_detail` VALUES ('18', '2', '6', '201', null, '100', null, '1');
INSERT INTO `tr_transfer_detail` VALUES ('19', '2', '12', '201', null, '0', null, '1');
INSERT INTO `tr_transfer_detail` VALUES ('20', '2', '3', '201', null, '250', null, '1');
INSERT INTO `tr_transfer_detail` VALUES ('21', '2', '5', '201', null, '100', null, '1');
INSERT INTO `tr_transfer_detail` VALUES ('22', '2', '6', '201', null, '100', null, '1');
INSERT INTO `tr_transfer_detail` VALUES ('23', '2', '12', '201', null, '0', null, '1');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`%` SQL SECURITY DEFINER VIEW `v_status_barang` AS (select `purlog`.`ref_barang`.`kode_barang` AS `kode_barang`,(case `purlog`.`ref_barang`.`status` when '1' then 'Aktif' else 'Tidak Aktif' end) AS `status_barang` from `ref_barang`);

-- ----------------------------
-- View structure for `v_status_courir`
-- ----------------------------
DROP VIEW IF EXISTS `v_status_courir`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`%` SQL SECURITY DEFINER VIEW `v_status_courir` AS (select `purlog`.`ref_courir`.`id_courir` AS `id_courir`,(case `purlog`.`ref_courir`.`status` when '1' then 'Aktif' else 'Tidak Aktif' end) AS `status_courir` from `ref_courir`);

-- ----------------------------
-- View structure for `v_status_kategori`
-- ----------------------------
DROP VIEW IF EXISTS `v_status_kategori`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`%` SQL SECURITY DEFINER VIEW `v_status_kategori` AS (select `purlog`.`ref_kategori`.`id_kategori` AS `id_kategori`,(case `purlog`.`ref_kategori`.`status` when '1' then 'Aktif' else 'Tidak Aktif' end) AS `status_kategori` from `ref_kategori`);

-- ----------------------------
-- View structure for `v_status_satuan`
-- ----------------------------
DROP VIEW IF EXISTS `v_status_satuan`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`%` SQL SECURITY DEFINER VIEW `v_status_satuan` AS (select `purlog`.`ref_satuan`.`id_satuan` AS `id_satuan`,(case `purlog`.`ref_satuan`.`status` when '1' then 'Aktif' else 'Tidak Aktif' end) AS `status_satuan` from `ref_satuan`);

-- ----------------------------
-- View structure for `v_status_sub_kategori`
-- ----------------------------
DROP VIEW IF EXISTS `v_status_sub_kategori`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`%` SQL SECURITY DEFINER VIEW `v_status_sub_kategori` AS (select `purlog`.`ref_sub_kategori`.`id_sub_kategori` AS `id_sub_kategori`,(case `purlog`.`ref_sub_kategori`.`status` when '1' then 'Aktif' else 'Tidak Aktif' end) AS `status_sub_kategori` from `ref_sub_kategori`);
...
DELIMITER ;;
CREATE TRIGGER `before_insert_in_detail` BEFORE INSERT ON `tr_in_detail` FOR EACH ROW SET new.date_create = CURRENT_TIMESTAMP()
;;
DELIMITER ;
