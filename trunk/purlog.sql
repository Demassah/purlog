...
INSERT INTO `sys_menu` VALUES ('48', 'Laporan', 'Laporan Picking', '47', 'laporan_picking', '1', '0', 'icon-po', 'PDF;EXCEL;');
INSERT INTO `sys_menu` VALUES ('49', 'Laporan', 'Laporan Delivery Order', '47', 'laporan_delivery', '2', '0', 'icon-po', 'PDF;EXCEL;');
INSERT INTO `sys_menu` VALUES ('50', 'Laporan', 'Laporan Document Receive', '47', 'laporan_document', '4', '0', 'icon-po', 'PDF;EXCEL;');
INSERT INTO `sys_menu` VALUES ('51', 'Laporan', 'Laporan Shipment', '47', 'laporan_shipment', '3', '0', 'icon-po', 'PDF;EXCEL;');
INSERT INTO `sys_menu` VALUES ('52', 'Laporan', 'Laporan Inbound', '47', 'laporan_inbound', '5', '0', 'icon-po', 'PDF;EXCEL;');
INSERT INTO `sys_menu` VALUES ('53', 'Laporan', 'Laporan Purchase', '47', 'laporan_purchase', '6', '0', 'icon-po', 'PDF;EXCEL;');
...
-- Records of tr_in
-- ----------------------------
INSERT INTO `tr_in` VALUES ('10', '17', '1', '2015-02-12 10:24:42', '16', '1');
...
-- ----------------------------
INSERT INTO `tr_in_detail` VALUES ('61', '10', '203', '2', '28', 'A100', '1');
INSERT INTO `tr_in_detail` VALUES ('62', '10', '203', '1', '28', 'A100', '1');
INSERT INTO `tr_in_detail` VALUES ('63', '10', '201', '3', '27', 'A100', '1');
...
INSERT INTO `tr_pros_detail` VALUES ('3', '9', '19', '3', '3', '201', '3', 'Pusat', '2015-02-03 13:51:25', '1', '1', '1');
...
-- ----------------------------
INSERT INTO `tr_receive` VALUES ('1', '1', '1', '2015-01-19 00:00:00', '1', '1');
INSERT INTO `tr_receive` VALUES ('2', '2', '2', '2015-01-19 00:00:00', '1', '2');
INSERT INTO `tr_receive` VALUES ('3', '1', '3', '2015-02-06 00:00:00', '1', '1');
...
INSERT INTO `tr_ro` VALUES ('23', '1', 'REQUEST', 'ATK', '123', '2015-02-10', '2015-02-10 14:25:17', '2015-02-10 14:25:57', '0000-00-00 00:00:00', '4', '1');
...
-- Records of tr_stock
-- ----------------------------
INSERT INTO `tr_stock` VALUES ('1', null, null, '301', '4', '1000', 'Workshop', '2015-01-20 10:54:09', '1', null);
INSERT INTO `tr_stock` VALUES ('2', null, null, '302', '10', '500', 'Heavy Equipment', '2015-01-20 10:54:09', '1', null);
INSERT INTO `tr_stock` VALUES ('3', null, null, '201', '10', '250', 'Pusat', '2015-01-20 10:54:09', '1', '0');
INSERT INTO `tr_stock` VALUES ('4', null, null, '100', '15', '210', 'IT', '2015-02-07 01:33:33', '1', null);
INSERT INTO `tr_stock` VALUES ('5', '2', '6', '201', '10', '100', 'Pusat', '2015-02-07 02:02:53', '1', '1');
INSERT INTO `tr_stock` VALUES ('6', '2', '7', '201', '74', '100', 'Pusat', '2015-02-07 02:02:53', '1', '1');
INSERT INTO `tr_stock` VALUES ('7', '2', '10', '301', '1', '1000', 'IT', '2015-02-09 22:28:31', '1', '2');
INSERT INTO `tr_stock` VALUES ('8', '1', '7', '301', '1', '1000', 'IT', '2015-02-09 22:40:49', '1', '2');
INSERT INTO `tr_stock` VALUES ('9', '1', '7', '301', '1', '1000', 'IT', '2015-02-09 22:42:43', '1', '2');
...
-- ----------------------------
INSERT INTO `tr_transfer_detail` VALUES ('7', '1', '1', '301', '1', '1000', 'IT', '1');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`%` SQL SECURITY DEFINER  VIEW `v_po_inbound` AS select
  `a`.`id_detail_qrs` AS `id_detail_qrs`,
  ...
  `a`.`qty`           AS `qty`,
  COALESCE(sum(`d`.`qty`),0) AS `receive`,
  (`a`.`qty` - SUM(COALESCE(`d`.`qty`,0))) AS `sisa`
from (((`tr_qrs_detail` `a`
     left join `tr_qrs` `b`
       on ((`a`.`id_qrs` = `b`.`id_qrs`)))
    left join `tr_po` `c`
      on ((`b`.`id_po` = `c`.`id_po`)))
   left join `tr_in_detail` `d`
     on ((`a`.`id_detail_qrs` = `d`.`ext_rec_no_detail`)))
where (`c`.`status` = 2 )
group by `a`.`id_detail_qrs`
order by `a`.`id_qrs` ;
