...
-- ----------------------------
INSERT INTO `tr_notifikasi` VALUES ('14', 'Request Order Baru telah dibuat', 'request_order', '0', null, '2', '1', '1', '0');
INSERT INTO `tr_notifikasi` VALUES ('15', 'Request Order Baru telah dibuat', 'request_order', '0', null, '1', '1', '1', '0');
INSERT INTO `tr_notifikasi` VALUES ('20', 'RO telah dikirim ke RO Approval', 'request_order_approval', '0', null, '1', '1', '1', '0');
INSERT INTO `tr_notifikasi` VALUES ('21', 'RO telah dikirim ke RO Approval', 'request_order_approval', '1', null, '1', '1', '1', '2');
INSERT INTO `tr_notifikasi` VALUES ('22', 'Data RO Approval Baru telah dikirim ke RO Logistic', 'request_order_logistic', '1', null, '1', '1', '1', '2');
INSERT INTO `tr_notifikasi` VALUES ('25', 'Data Request Order di Approve oleh Manager', 'request_order_logistic', '1', null, '1', '1', '1', '2');
INSERT INTO `tr_notifikasi` VALUES ('26', 'Purchase Request Baru telah dibuat', 'purchase_request', '1', null, '3', '1', '1', '2');
...
INSERT INTO `tr_pr` VALUES ('2', '2', null, '1', 'REQUEST', 'CETAKAN', '112233', '2015-01-20', '2015-01-20 10:54:09', '1');
...
-- Records of tr_qrs
-- ----------------------------
INSERT INTO `tr_qrs` VALUES ('3', '1', '1', '2015-01-30 22:49:55', '16', '1');
...
INSERT INTO `tr_ro` VALUES ('4', '1', 'REQUEST', 'ASSET', '554433', '2015-01-23', '2015-01-23 13:53:19', '2015-01-23 14:54:11', '0000-00-00 00:00:00', '4', '1');
...
INSERT INTO `tr_ro` VALUES ('11', '1', 'STOCK', 'ATK', '546', '2015-01-28', '2015-01-28 10:55:38', '2015-01-28 13:40:21', '0000-00-00 00:00:00', '3', '1');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`%` SQL SECURITY DEFINER  VIEW `v_qrs_detail` AS (select `a`.`id_detail_pr` AS `id_detail_pr`,`a`.`id_pr` AS `id_pr`,`a`.`id_ro` AS `id_ro`,b.id_detail_qrs,
				`a`.`kode_barang` AS `kode_barang`,`a`.`qty` AS `qty`,coalesce(sum(`b`.`qty`),0) AS `pick`,
				(`a`.`qty` - coalesce(sum(`b`.`qty`),0)) AS `sisa` 
from ((`tr_pr_detail` `a` left join `tr_pr` `c` on((`a`.`id_pr` = `c`.`id_pr`))) left join `tr_qrs_detail` `b` on((`a`.`id_detail_pr` = `b`.`id_detail_pr`))) where (`c`.`status` = 2) group by `a`.`id_detail_pr`) ;
