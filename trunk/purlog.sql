...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`purlog` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
insert  into `ref_lokasi`(`id_lks`,`id_lokasi`,`type`,`storage`,`status`) values (1,'A100',1,1,1),(2,'B100',2,2,1),(3,'C100',2,3,1);
...
insert  into `sys_menu`(`menu_id`,`menu_group`,`menu_name`,`menu_parent`,`url`,`position`,`hide`,`icon_class`,`policy`) values (1,'Administrator','Administrator',0,'#',99,0,'icon-administrator','ACCESS;'),(2,'Administrator','Otoritas Menu',1,'otoritas',2,0,'icon-otoritas','ACCESS;ADD;EDIT;DETAIL;DELETE;'),(3,'Administrator','Pengguna',1,'pengguna',3,0,'icon-user','ACCESS;ADD;EDIT;DELETE;'),(4,'Setup','Departemen',36,'departement',2,0,'icon-departement','ACCESS;ADD;EDIT;DELETE;'),(5,'Master Data','Master Data',0,'#',2,0,'icon-master','ACCESS;'),(6,'Master Data','Kategori',5,'kategori',2,0,'icon-kategori','ACCESS;ADD;EDIT;DELETE;'),(7,'Master Data','Sub Kategori',5,'sub_kategori',3,0,'icon-subkateg','ACCESS;ADD;EDIT;DELETE;'),(8,'Master Data','Barang',5,'barang',4,0,'icon-barang','ACCESS;ADD;EDIT;DELETE;PDF;'),(9,'Purchase','Purchase',0,'#',4,0,'icon-purchase','ACCESS;ADD;EDIT;DELETE;DETAIL;'),(10,'Logistic','Request Order',34,'request_order',2,0,'icon-ro','ACCESS;ADD;EDIT;DELETE;DETAIL;APPROVE;PDF;'),(11,'Logistic','Request Order Selected',34,'request_order_selected',5,0,'icon-ros','ACCESS;EDIT;DELETE;DETAIL;APPROVE;PDF;'),(12,'Logistic','Picking Request Order Selected',34,'picking_req_order_selected',6,0,'icon-picking','ACCESS;DETAIL;EDIT;PDF;APPROVE;'),(13,'Logistic','Shipment Request Order',34,'shipment_req_order',7,0,'icon-shipment','ACCESS;ADD;DETAIL;DELETE;PDF;APPROVE;'),(14,'Purchase','Purchase Request',9,'purchase_request',7,0,'icon-pr','ACCESS;ADD;DELETE;DETAIL;APPROVE;'),(15,'Purchase','Quotation Request Selected',9,'quotation_request_selected',8,0,'icon-qrs','ACCESS;ADD;DELETE;DETAIL;SELECT;APPROVE;'),(17,'Purchase','Purchase Order',9,'purchase_order',10,0,'icon-po','ACCESS;ADD;DELETE;PDF;APPROVE;SELECT;DETAIL;'),(18,'Purchase','Document Receive',34,'document_receive',10,0,'icon-dr','ACCESS;ADD;EDIT;DELETE;PRINT;IMPORT;PDF;EXCEL;APPROVE;'),(19,'Logistic','Delivery Order',34,'delivery_order',8,0,'icon-delivery','ACCESS;ADD;DETAIL;DELETE;PDF;APPROVE;'),(20,'Purchase','Berita Acara Pengembalian',9,'underconstruction',12,0,'icon-bap','ACCESS;ADD;EDIT;DELETE;DETAIL;'),(21,'Logistic','Return',34,'retur',13,0,'icon-bapp','ACCESS;ADD;DETAIL;'),(22,'Logistic','Request Order Logistic',34,'request_order_logistic',4,0,'icon-rol','ACCESS;DETAIL;APPROVE;'),(23,'Administrator','Menu',1,'menu',1,0,'icon-menu','ACCESS;ADD;EDIT;DELETE;'),(34,'Logistic','Logistic',0,'#',3,0,'icon-logistic','ACCESS;'),(36,'Setup','Setup',0,'#',1,0,'icon-setup','ACCESS;'),(37,'Logistic','Request Order Approval',34,'request_order_approval',3,0,'icon-approval','ACCESS;ADD;EDIT;DELETE;DETAIL;APPROVE;'),(38,'Logistic','Delivered',34,'delivered',9,0,'icon-delivered','ACCESS;DETAIL;'),(39,'Purchase','Ordered',9,'ordered',11,0,'icon-ordered','DETAIL;'),(40,'Logistic','Alocate Return',34,'alocate_return',14,1,'','ACCESS;DETAIL;'),(41,'Logistic','Inbound',34,'inbound',20,0,'icon-inbound','ACCESS;ADD;DETAIL;DELETE;PDF;APPROVE;'),(42,'Logistic','Stock On Hand',34,'soh',21,0,'icon-stock','ACCESS;'),(43,'Logistic','Transfer',34,'transfer',26,0,'icon-transfer','ACCESS;ADD;EDIT;DELETE;DETAIL;APPROVE;'),(44,'Setup','Satuan',36,'satuan',3,0,'icon-satuan','ACCESS;ADD;EDIT;DELETE;'),(45,'Master Data','Kurir',5,'courir',5,0,'icon-po','ACCESS;ADD;EDIT;DELETE;'),(46,'Master Data','Lokasi',5,'lokasi',6,0,'icon-otoritas','ACCESS;ADD;EDIT;DELETE;'),(47,'Laporan','Laporan',0,'#',5,0,'icon-ordered','ACCESS;'),(48,'Laporan','Laporan Picking',47,'laporan_picking',1,0,'icon-po','ACCESS;PDF;EXCEL;'),(49,'Laporan','Laporan Delivery Order',47,'laporan_delivery',2,0,'icon-po','ACCESS;PDF;EXCEL;'),(50,'Laporan','Laporan Document Receive',47,'laporan_document',4,0,'icon-po','ACCESS;PDF;EXCEL;'),(51,'Laporan','Laporan Shipment',47,'laporan_shipment',3,0,'icon-po','ACCESS;PDF;EXCEL;'),(52,'Laporan','Laporan Inbound',47,'laporan_inbound',5,0,'icon-po','ACCESS;PDF;EXCEL;'),(53,'Laporan','Laporan Purchase',47,'laporan_purchase',6,0,'icon-po','ACCESS;PDF;EXCEL;'),(54,'Laporan','Laporan Pembelian',47,'laporan_pembelian',7,0,'icon-po','ACCESS;PDF;EXCEL;'),(55,'Laporan','Laporan Outstanding Supply',47,'laporan_outstanding',8,0,'icon-po','ACCESS;PDF;EXCEL;'),(56,'Laporan','Laporan Penerimaan ',47,'laporan_penerimaan',9,0,'icon-po','ACCESS;PDF;EXCEL;'),(57,'Laporan','Laporan Pemakaian',47,'laporan_usage',10,0,'icon-po','ACCESS;PDF;EXCEL;'),(58,'Laporan','Laporan Persediaan',47,'laporan_persediaan',11,0,'icon-po','ACCESS;PDF;EXCEL;');
...
insert  into `tr_in`(`id_in`,`ext_rec_no`,`type`,`date_create`,`user_id`,`status`) values (3,1,'1','2015-03-24 16:03:48',1,1);
...
insert  into `tr_notifikasi`(`id`,`context`,`url`,`id_object`,`status`,`tanggal`,`type`,`binding_type`,`binding_id`,`user_level_id`) values (41,'Request Order telah dikirim ke RO Approval','request_order_approval',19,0,'0000-00-00',1,1,1,2),(42,'Purchase Request Baru telah dibuat','purchase_request',4,0,'0000-00-00',3,1,1,3),(43,'Request Order Baru telah dibuat','request_order',20,0,'0000-00-00',1,1,1,2),(44,'Request Order telah dikirim ke RO Approval','request_order_approval',20,0,'0000-00-00',1,1,1,2),(45,'Purchase Request Baru telah dibuat','purchase_request',5,0,'0000-00-00',3,1,1,3),(46,'Request Order Baru telah dibuat','request_order',21,0,'0000-00-00',1,1,1,2),(47,'Request Order telah dikirim ke RO Approval','request_order_approval',21,0,'0000-00-00',1,1,1,2),(48,'RO Approval telah dikirim ke RO Logistic','request_order_logistic',21,0,'0000-00-00',1,1,1,2),(49,'RO Logistic telah dikirim ke RO Selected','request_order_selected',21,0,'0000-00-00',1,1,1,2),(50,'Purchase Request Baru telah dibuat','purchase_request',6,0,'0000-00-00',3,1,1,3),(51,'Request Order Baru telah dibuat','request_order',22,0,'0000-00-00',1,1,1,2),(52,'Request Order Baru telah dibuat','request_order',23,0,'0000-00-00',1,1,1,2),(53,'Request Order telah dikirim ke RO Approval','request_order_approval',23,0,'0000-00-00',1,1,1,2),(54,'RO Approval telah dikirim ke RO Logistic','request_order_logistic',23,0,'0000-00-00',1,1,1,2),(55,'RO Logistic telah dikirim ke RO Selected','request_order_selected',23,1,'0000-00-00',1,1,1,2),(56,'Request Order Baru telah dibuat','request_order',24,0,'0000-00-00',1,1,1,2),(57,'Request Order telah dikirim ke RO Approval','request_order_approval',24,0,'0000-00-00',1,1,1,2),(58,'RO Approval telah dikirim ke RO Logistic','request_order_logistic',24,0,'0000-00-00',1,1,1,2),(59,'RO Logistic telah dikirim ke RO Selected','request_order_selected',24,0,'0000-00-00',1,1,1,2),(60,'Request Order Baru telah dibuat','request_order',25,0,'0000-00-00',1,1,1,2),(61,'Request Order telah dikirim ke RO Approval','request_order_approval',25,0,'0000-00-00',1,1,1,2),(62,'RO Approval telah dikirim ke RO Logistic','request_order_logistic',25,0,'0000-00-00',1,1,1,2),(63,'RO Logistic telah dikirim ke RO Selected','request_order_selected',25,0,'0000-00-00',1,1,1,2),(64,'Purchase Request Baru telah dibuat','purchase_request',7,0,'0000-00-00',3,1,1,3),(65,'Request Order telah dikirim ke RO Approval','request_order_approval',22,0,'0000-00-00',1,1,1,2),(66,'RO Approval telah dikirim ke RO Logistic','request_order_logistic',22,0,'0000-00-00',1,1,1,2),(67,'RO Logistic telah dikirim ke RO Selected','request_order_selected',22,0,'0000-00-00',1,1,1,2),(68,'Request Order Baru telah dibuat','request_order',1,0,'0000-00-00',1,1,1,2),(69,'Request Order telah dikirim ke RO Approval','request_order_approval',1,0,'0000-00-00',1,1,1,2),(70,'RO Approval telah dikirim ke RO Logistic','request_order_logistic',1,0,'0000-00-00',1,1,1,2),(71,'RO Logistic telah dikirim ke RO Selected','request_order_selected',1,0,'0000-00-00',1,1,1,2),(72,'Purchase Request Baru telah dibuat','purchase_request',1,0,'0000-00-00',3,1,1,3);
...
insert  into `tr_po`(`id_po`,`id_qrs`,`id_pr`,`id_ro`,`requestor`,`departement`,`purpose`,`cat_req`,`ext_doc_no`,`ETD`,`date_create`,`status`) values (1,1,1,1,'1','1','STOCK','SPAREPART','1234','2015-03-24','2015-03-24 15:29:31',2);
...
insert  into `tr_pr`(`id_pr`,`id_ro`,`id_po`,`user_id`,`purpose`,`cat_req`,`ext_doc_no`,`ETD`,`date_create`,`status`) values (1,1,NULL,1,'STOCK','SPAREPART','1234','2015-03-24','2015-03-24 15:20:45',2);
...
insert  into `tr_pr_detail`(`id_detail_pr`,`id_pr`,`id_detail_ro`,`id_ro`,`kode_barang`,`qty`,`user_id`,`date_create`,`note`,`status`,`status_delete`) values (1,1,1,1,'302',20,1,'2015-03-24 15:22:05',NULL,2,0),(2,1,2,1,'301',23,1,'2015-03-24 15:22:05',NULL,2,0);
...
insert  into `tr_qr`(`id_qr`,`id_qrs`,`id_pr`,`id_vendor`,`id_po`,`top`,`ETD`,`status`) values (2,1,1,'V002',1,30,'2015-03-24',2),(3,1,1,'V001',0,12,'2015-03-24',1),(4,1,1,'V003',0,12,'2015-03-24',1);
...
insert  into `tr_qr_detail`(`id_detail_qr`,`id_qr`,`id_qrs`,`id_detail_pr`,`id_pr`,`kode_barang`,`qty`,`price`,`date_create`,`status`) values (1,2,1,1,1,'302',10,25000,'2015-03-24 15:24:53',1),(2,2,1,2,1,'301',13,8000,'2015-03-24 15:24:53',1),(3,3,1,1,1,'302',10,30000,'2015-03-24 15:25:56',1),(4,3,1,2,1,'301',13,10000,'2015-03-24 15:25:56',1),(5,4,1,1,1,'302',10,28000,'2015-03-24 15:27:30',1),(6,4,1,2,1,'301',13,7000,'2015-03-24 15:27:30',1);
...
insert  into `tr_qrs`(`id_qrs`,`id_po`,`id_pr`,`id_ro`,`date_create`,`user_id`,`status`) values (1,1,1,1,'2015-03-24 15:23:16',1,2);
...
insert  into `tr_qrs_detail`(`id_detail_qrs`,`id_qrs`,`id_pr`,`id_detail_pr`,`kode_barang`,`qty`,`status`) values (1,1,1,1,'302',10,1),(2,1,1,2,'301',13,1);
...
insert  into `tr_ro`(`id_ro`,`user_id`,`purpose`,`cat_req`,`ext_doc_no`,`ETD`,`date_create`,`date_approve`,`date_reject`,`no_rangka`,`no_polisi`,`status`,`status_order`) values (1,1,'STOCK','SPAREPART','1234','2015-03-24','2015-03-24 15:20:45','2015-03-24 15:21:58','0000-00-00 00:00:00','123678','D123',6,1);
...
insert  into `tr_ro_detail`(`id_detail_ro`,`id_ro`,`ext_doc_no`,`kode_barang`,`qty`,`barang_bekas`,`user_id`,`date_create`,`note`,`status`,`status_delete`,`id_sro`) values (1,1,'1234','302',20,2,1,'2015-03-24 15:20:45','-',1,0,0),(2,1,'1234','301',23,1,1,'2015-03-24 15:20:45','-',1,0,0);
...
insert  into `tr_stock`(`id_stock`,`id_in`,`id_detail_in`,`kode_barang`,`qty`,`price`,`id_lokasi`,`date_create`,`status`,`type_in`) values (2,1,7,'201',6,0,'A100','2015-03-24 17:52:15',1,2),(3,2,8,'201',23,0,'A100','2015-03-24 17:55:02',1,2);
...
insert  into `tr_transfer`(`id_transfer`,`type_transfer`,`note`,`date_create`,`user_id`,`status`) values (1,1,'we','2015-03-24 16:29:32',1,2),(2,1,'weee','2015-03-24 17:54:49',1,2);
...
insert  into `tr_transfer_detail`(`id_detail_transfer`,`id_transfer`,`id_stock`,`kode_barang`,`qty`,`price`,`id_lokasi`,`status`) values (7,1,1,'201',29,0,'A100',1),(8,2,2,'201',23,0,'A100',1);
...
/* Trigger structure for table `tr_in_detail` */

DELIMITER $$

/*!50003 DROP TRIGGER*//*!50032 IF EXISTS */ /*!50003 `before_insert_in_detail` */$$

/*!50003 CREATE */ /*!50017 DEFINER = 'root'@'localhost' */ /*!50003 TRIGGER `before_insert_in_detail` BEFORE INSERT ON `tr_in_detail` FOR EACH ROW SET new.date_create = CURRENT_TIMESTAMP() */$$
...
/* Procedure structure for procedure `p_transfer_detail` */

/*!50003 DROP PROCEDURE IF EXISTS  `p_transfer_detail` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `p_transfer_detail`(IN p_id_stock INT, in p_qty int, in p_status int)
BEGIN
	DECLARE done INT DEFAULT FALSE;
	DECLARE a INT;
	DECLARE b float;
...
/*!50001 DROP VIEW IF EXISTS `v_lokasi` */;
/*!50001 DROP TABLE IF EXISTS `v_lokasi` */;

/*!50001 CREATE TABLE  `v_lokasi`(
 `id_lks` int(11) ,
 `type` tinyint(1) ,
...
/*!50001 DROP VIEW IF EXISTS `v_po_detail_2` */;
/*!50001 DROP TABLE IF EXISTS `v_po_detail_2` */;

/*!50001 CREATE TABLE  `v_po_detail_2`(
 `id_po` int(11) ,
...
/*!50001 DROP VIEW IF EXISTS `v_po_inbound_2` */;
/*!50001 DROP TABLE IF EXISTS `v_po_inbound_2` */;

/*!50001 CREATE TABLE  `v_po_inbound_2`(
 `id_detail_pr` int(11) ,
 `id_pr` int(11) ,
 `id_po` int(11) ,
 `kode_barang` varchar(21) ,
...
/*!50001 DROP VIEW IF EXISTS `v_status_courir` */;
/*!50001 DROP TABLE IF EXISTS `v_status_courir` */;

/*!50001 CREATE TABLE  `v_status_courir`(
 `id_courir` int(11) ,
...
/*View structure for view v_lokasi */
...
/*View structure for view v_po_detail_2 */
...
/*View structure for view v_po_inbound_2 */
...
/*View structure for view v_status_courir */

/*!50001 DROP TABLE IF EXISTS `v_status_courir` */;
/*!50001 DROP VIEW IF EXISTS `v_status_courir` */;

/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`%` SQL SECURITY DEFINER VIEW `v_status_courir` AS (select `ref_courir`.`id_courir` AS `id_courir`,(case `ref_courir`.`status` when '1' then 'Aktif' else 'Tidak Aktif' end) AS `status_courir` from `ref_courir`) */;
