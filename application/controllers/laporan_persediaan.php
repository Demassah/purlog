...
function laporan_excel_kode($date_1) {
    ...
    $this->excel_generator->set_header(array('ID Stock','Kode Barang','Nama Barang','Qty Stock','Price','Date Create'));
    $this->excel_generator->set_column(array('id_stock','kode_barang','nama_barang','stock','price','date_create'));
