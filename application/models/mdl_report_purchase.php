...
class mdl_report_purchase extends CI_Model {

	function __construct(){
	    parent::__construct();
    }
	
	function getdata_report_purchase($plimit=true){
		...
		$this->db->flush_cache();
		$this->db->start_cache();
		$this->db->select('*, a.id_pr, a.id_ro, a.qty, a.note, a.kode_barang, b.full_name, c.nama_barang, e.departement_name, d.etd');
		...
		$this->db->join('ref_departement e', 'e.departement_id = b.departement_id');
	...
	function report_purchase_excel($date_1,$date_2)
	{
		$this->db->flush_cache();
		$this->db->start_cache();
		$this->db->select('*, a.id_pr, a.id_ro, a.qty, a.note, a.kode_barang, b.full_name, c.nama_barang, e.departement_name, d.etd');
	...
	function report_purchase_pdf($date_1,$date_2)
	{
		$this->db->flush_cache();
		$this->db->start_cache();
		$this->db->select('*, a.id_pr, a.id_ro, a.qty, a.note, a.kode_barang, b.full_name, c.nama_barang, e.departement_name, d.etd');
