...
//$db['default']['hostname'] = '192.168.112.244';
...
$db['sample']['hostname'] = 'localhost';
$db['sample']['username'] = 'root';
$db['sample']['password'] = '';
$db['sample']['database'] = 'sample';
$db['sample']['dbdriver'] = 'mysql';
$db['sample']['dbprefix'] = '';
$db['sample']['pconnect'] = TRUE;
