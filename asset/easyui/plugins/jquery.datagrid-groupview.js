var groupview = $.extend({}, $.fn.datagrid.defaults.view, {
	...
	renderGroup: function(target, groupIndex, group, frozen){
		...
		if ((frozen && (opts.rownumbers || opts.frozenColumns.length)) ||
			...
			table.push('<td style="border:0;text-align:center;width:25px"><span class="datagrid-row-expander datagrid-row-expand" style="display:inline-block;width:16px;height:16px;cursor:pointer">&nbsp;</span></td>');
		}
		...
		table.push('<table class="datagrid-btable" cellspacing="0" cellpadding="0" border="0" style="display:none;"><tbody>');
